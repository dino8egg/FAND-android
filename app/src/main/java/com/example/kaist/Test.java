            ...
            public void onClick(View v) {
                ...
                if(result==-1){
                    ...
                    try{
                        ...
                        final String[] simple_app_names = new String[apps.length];
                        for(int i=0; i<apps.length; i++){
                            String[] tmp = apps[i].split("\\.");
                            simple_app_names[i] = tmp[tmp.length - 1];
                        }
                        AlertDialog.Builder builder = new AlertDialog.Builder(Test.this);
                        builder.setTitle("Welcome " + person_name + "! " + person_name + "'s App List");
                        builder.setItems(simple_app_names, new DialogInterface.OnClickListener() {
                            @Override
